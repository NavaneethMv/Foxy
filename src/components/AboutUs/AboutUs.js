            ...
            <div className="container">
                ...
                <div className="gallery-section">
                    ...
                    <div className="gallery-collage">
                        <img src="image1.jpg" alt="Destination 1" className="gallery-image img1" />
                        <img src="image2.jpg" alt="Destination 2" className="gallery-image img2" />
                        <img src="image3.jpg" alt="Destination 3" className="gallery-image img3" />
                        <img src="image4.jpg" alt="Destination 4" className="gallery-image img4" />
                        <img src="image5.jpg" alt="Destination 5" className="gallery-image img5" />
                    </div>
                </div>
            </div>
        </section>
